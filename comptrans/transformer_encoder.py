...
def module_name_fordropout(module_name: str) -> str:
    if module_name == 'TransformerEncoderCompBase':
        return 'TransformerEncoderComp'
    else:
        return module_name
...
class TransformerEncoderCompBase(FairseqEncoder):
    ...
    def __init__(self, cfg, dictionary, embed_tokens):
        ...
        self.layers.extend(
            [self.build_encoder_layer(cfg, str(i)) for i in range(cfg.encoder.layers)]
        )
    ...
    def build_encoder_layer(self, cfg, layer):
        layer = comptransformer_layer.TransformerEncoderLayerCompBase(cfg, layer)
...
class TransformerEncoderComp(TransformerEncoderCompBase):
