...
#########
import sys
sys.path.insert(1, '/home/panso014/diploma/fairseq/')
from train_iter_freezing import main as pre_main_iter
#########
        ...
        if cfg.common.profile:
            with torch.cuda.profiler.profile():
                with torch.autograd.profiler.emit_nvtx():
                    distributed_utils.call_main(cfg, pre_main_iter, **kwargs)
